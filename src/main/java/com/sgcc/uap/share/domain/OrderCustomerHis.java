...
/**
 * OrderCustomerHis的POJO类
 * @author 18511 
 */
@Entity
@Table(name = "order_customer_his")
public class OrderCustomerHis implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof OrderCustomerHis))
	        return false; 
	        
		if (getClass() != obj.getClass())
			return false;
		
		OrderCustomerHis other = (OrderCustomerHis) obj;
