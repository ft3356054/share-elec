...
/**
 * OrderElectrician的POJO类
 * @author 18511 
 */
@Entity
@Table(name = "order_electrician")
public class OrderElectrician implements Serializable {
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof OrderElectrician))
	        return false; 
	        
		if (getClass() != obj.getClass())
			return false;
		
		OrderElectrician other = (OrderElectrician) obj;
