...
public class NotifyAnnounceUserController {
	...
	/**
	 * @getByAnnounceUserId:根据announceUserId查询
	 * @param announceUserId
	 * @return WrappedResult 查询结果
	 * @date 2020-11-26 14:32:47
	 * @author 18511
	 */
	@RequestMapping(value = "/{announceUserId}")
	public WrappedResult getByAnnounceUserId(@PathVariable String announceUserId) {
		try {
			QueryResultObject result = notifyAnnounceUserService.getNotifyAnnounceUserByAnnounceUserId(announceUserId);
			logger.info("查询成功"); 
