...
/**
 * OrderElectricianHis的VO类
 *
 * @author 18511 
 */
public class OrderElectricianHisVO extends ParentVO implements Serializable{
    ...
    /**
     * OrderElectricianHisVO构造函数
     */
    public OrderElectricianHisVO() {
        super();
    } 
   
	 /**
     * OrderElectricianHisVO完整的构造函数
     */  
    public OrderElectricianHisVO(String orderElectricianId){
