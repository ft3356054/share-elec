...
/**
 * AuthorityUserRole的VO类
 *
 * @author 18511 
 */
public class AuthorityUserRoleVO extends ParentVO implements Serializable{
    ...
    /**
     * AuthorityUserRoleVO构造函数
     */
    public AuthorityUserRoleVO() {
        super();
    } 
   
	 /**
     * AuthorityUserRoleVO完整的构造函数
     */  
    public AuthorityUserRoleVO(String id){
        this.id = id;
    }
    /**
     * ID的get方法
