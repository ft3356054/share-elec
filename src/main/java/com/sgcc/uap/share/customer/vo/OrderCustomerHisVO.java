...
/**
 * OrderCustomerHis的VO类
 *
 * @author 18511 
 */
public class OrderCustomerHisVO extends ParentVO implements Serializable{
    ...
    /**
     * OrderCustomerHisVO构造函数
     */
    public OrderCustomerHisVO() {
        super();
    } 
   
	 /**
     * OrderCustomerHisVO完整的构造函数
     */  
    public OrderCustomerHisVO(String orderId){
