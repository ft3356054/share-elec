...
import net.sf.json.JSONObject;
	...
	*/
	public class JsonUtils {
		...
		custPosition.setAreaId("123");
		custPosition.setCustomerId("123");
		custPosition.setLat("123");
		custPosition.setLon("123");
		custPosition.setOrderId("123");
		System.out.println(objToJson(custPosition));
		
		System.out.println(com.sgcc.uap.utils.json.JsonUtils.toJson(custPosition));
		System.out.println(com.sgcc.uap.utils.json.JsonUtils.toJsonString(custPosition));
		}
	...
	* @return
	*/
	public static String objToJson(Object jsonObj) {
		JSONObject jsonObject = JSONObject.fromObject(jsonObj);
		Map<Object, Object> map = (Map)jsonObject;
		JSONObject json = JSONObject.fromObject(map);
		return json.toString();
